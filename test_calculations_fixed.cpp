...
TEST_CASE("TestTriangle_from_test_plan", "[test_plan]") {
...
TEST_CASE("TestRectangle_from_test_plan", "[test_plan]") {
...
TEST_CASE("TestCircle_from_test_plan", "[test_plan]") {
...
TEST_CASE("TestSquare_from_test_plan", "[test_plan]") {
...
TEST_CASE("Translation_of_shapes", "[test_plan]") {
...
TEST_CASE("Scaling_of_shapes", "[test_plan]") {
    Coordinates pos(10, 10);
    Rectangle r(pos, 30, 40);
...
TEST_CASE("TestTriangle_additional_calculations", "[test_plan]") {
...
TEST_CASE("Rectangle_with_zero_or_negative_dimensions", "[error_handling]") {
    // Zero width
...
TEST_CASE("Square_with_zero_or_negative_side", "[error_handling]") {
    // Zero side
...
TEST_CASE("Circle_with_zero_or_negative_radius", "[error_handling]") {
    // Zero radius
...
TEST_CASE("Triangle_collinear_points", "[error_handling]") {
...
TEST_CASE("Triangle_inequality_theorem_violations", "[error_handling]") {
...
TEST_CASE("Rectangle_scaling_with_invalid_factor", "[error_handling]") {
...
TEST_CASE("Circle_scaling_with_invalid_factor", "[error_handling]") {
...
TEST_CASE("Triangle_scaling_with_invalid_factor", "[error_handling]") {
...
TEST_CASE("ShapeList_adding_null_pointer", "[error_handling]") {
    ShapeList list;
...
TEST_CASE("ShapeList_removing_shape_at_invalid_index", "[error_handling]") {
    ShapeList list;
...
TEST_CASE("ShapeList_getting_shape_at_invalid_index", "[error_handling]") {
    ShapeList list;
...
TEST_CASE("ShapeList_performance_optimizations", "[error_handling]") {
    ShapeList list;
